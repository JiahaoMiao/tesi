...
\begin{flalign}
    ...
    &+ \ln \tilde{C}\qty(\alpha_s(\mu^2),\frac{\mu^2}{Q^2})
\end{flalign}
...
\begin{flalign}\label{eq:f1}
    f_1(\lambda) =-\frac{A_1}{2 \pi  b_0 \lambda } \qty[(1-2 \lambda ) \log (1-2 \lambda )-2 (1-\lambda ) \log (1-\lambda )]
\end{flalign}


\begin{flalign}\label{eq:f2}
    f_2(\lambda) &= -\frac{A_2}{2 \pi ^2 b_0^2} \qty[2 \log (1-\lambda )-\log (1-2 \lambda )]+\frac{B_1 \log (1-\lambda )}{2 \pi  b_0} +\frac{\gamma  A_1}{\pi  b_0} \qty[\log (1-2 \lambda )-\log (1-\lambda )] & \nonumber\\
    &-\frac{A_1 b_1}{2 \pi  b_0^3} \left[-\log ^2(1-\lambda )+\frac{1}{2} \log ^2(1-2 \lambda )-2 \log (1-\lambda )+\log (1-2 \lambda )\right]
\end{flalign}
...
\begin{flalign}\label{eq:f3}
    ...
    &+\frac{b_1 A_2}{2 \pi ^2 b_0^3 (\lambda -1) (2 \lambda -1)} \left[3 \lambda ^2 + (1-\lambda) \log (1-2 \lambda)- 2 (1-2 \lambda) \log (1-\lambda)\right]& \nonumber \\
    &-\frac{\gamma A_2 \lambda }{\pi ^2 b_0 (\lambda -1) (2 \lambda -1)} - \frac{B_1 b_1 }{2 \pi  b_0^2 (\lambda -1)}\qty[\lambda +\log (1-\lambda )] + \frac{\gamma B_1 \lambda}{2 \pi  (\lambda -1)}+\frac{\gamma ^2 A_1 \lambda  (2 \lambda -3)}{2 \pi  (\lambda -1) (2 \lambda -1)}& \nonumber \\ 
    &+ \frac{b_1 \gamma A_1}{\pi  b_0^2 (\lambda -1) (2 \lambda -1)}  \qty[-\lambda +(1-2 \lambda)  \log (1-\lambda )- (1-\lambda)  \log (1-2 \lambda )] \\
    &-\frac{b_1^2 A_1}{2 \pi  b_0^4 (\lambda -1) (2 \lambda -1)} \Bigl[\left(\lambda ^2+(2 \lambda -1) \log (1-\lambda ) (2 \lambda +\log (1-\lambda ))\right)&\nonumber\\
    &+\frac{1}{2}\left((1-\lambda) \log ^2(1-2 \lambda )\right)-2 (\lambda -1) \lambda  \log (1-2 \lambda )\Bigr] & \nonumber\\
    &-\frac{b_0 b_2 A_1}{2 \pi  b_0^4 (\lambda -1) (2 \lambda -1)} \left[\lambda ^2+ (\lambda -1) (2 \lambda -1)\qty(2 \log (1-\lambda )+ \log (1-2 \lambda ))\right] & \nonumber
\end{flalign}
...
\begin{flalign}\label{eq:f4}
    ...
    &+10 (\lambda -3) \lambda^3+3 (\lambda -1)^2 \log (1-2 \lambda )-6 (1-2 \lambda )^2 \log (1-\lambda )\Bigr]& \nonumber\\
    &+\frac{\gamma A_3 \lambda  (3 \lambda -2)}{2 \pi ^3 b_0 (\lambda -1)^2 (2 \lambda -1)^2}+\frac{\gamma B_2 (\lambda -2) \lambda }{2 \pi ^2 (\lambda -1)^2}-\frac{b_1 B_2 \left[\lambda ^2-2 \lambda -2 \log (1-\lambda )\right]}{4 \pi ^2 b_0^2 (\lambda -1)^2} & \nonumber\\
    &+\frac{\gamma ^2 A_2 \lambda  \left(4 \lambda ^3-12 \lambda ^2+15 \lambda -6\right)}{2 \pi ^2 (\lambda -1)^2 (2 \lambda -1)^2}+\frac{b_1 \gamma A_2}{2 \pi ^2 b_0^2 (\lambda -1)^2 (2 \lambda -1)^2}  \Bigl[\lambda  (2-3 \lambda ) &\nonumber\\
    &+2 (\lambda -1)^2 \log (1-2 \lambda )-2 (1-2 \lambda )^2 \log (1-\lambda )\Bigr] +\frac{b_2 A_2 \lambda ^3 (4 \lambda -3)}{3 \pi ^2 b_0^3 (\lambda -1)^2 (2 \lambda -1)^2}& \nonumber\\
    &-\frac{b_1^2 A_2}{12 \pi ^2 b_0^4 (\lambda -1)^2 (2 \lambda -1)^2} \Bigl[\lambda ^2 \left(22 \lambda ^2-30 \lambda +9\right)+3 (\lambda -1)^2 \log ^2(1-2 \lambda )&\nonumber\\
    &+3 (\lambda -1)^2 \log (1-2 \lambda )-6 (1-2 \lambda )^2 \log (1-\lambda ) (\log (1-\lambda )+1)\Bigr] \\
    &+\frac{b_0 \gamma ^2 B_1 (\lambda -2) \lambda }{4 \pi  (\lambda -1)^2} +\frac{b_1 \gamma B_1 \log (1-\lambda )}{2 \pi  b_0 (\lambda -1)^2} + \frac{b_2 B_1 \lambda ^2}{4 \pi  b_0^2 (\lambda -1)^2} & \nonumber\\
    &+ \frac{b_1^2 B_1 (\lambda -\log (1-\lambda )) (\lambda +\log (1-\lambda ))}{4 \pi  b_0^3 (\lambda -1)^2} +\frac{b_0 \gamma ^3 A_1 \lambda  \left(12 \lambda ^3-36 \lambda ^2+39 \lambda -14\right)}{6 \pi  (\lambda -1)^2 (2 \lambda -1)^2}& \nonumber\\
    &+\frac{b_1 \gamma ^2 A_1}{2 \pi  b_0 (\lambda -1)^2 (2 \lambda -1)^2} \left[2 (\lambda -1)^2 \log (1-2 \lambda )-(1-2 \lambda )^2 \log (1-\lambda )\right] &\nonumber\\
    &-\frac{b_1^2 \gamma A_1}{2 \pi  b_0^3 A_1 (\lambda -1)^2 (2 \lambda -1)^2} \left[(4 \lambda -3) \lambda ^2-(1-2 \lambda )^2 \log ^2(1-\lambda )+(\lambda -1)^2 \log ^2(1-2 \lambda )\right]&\nonumber\\
    &-\frac{b_1^3 A_1}{12 \pi  b_0^5 (\lambda -1)^2 (2 \lambda -1)^2} \Bigl[4 (3-4 \lambda ) \lambda ^3+2 (1-2 \lambda )^2 \log (1-\lambda ) \left(\log ^2(1-\lambda )-3 \lambda ^2\right)&\nonumber\\
    &+12 (\lambda -1)^2 \lambda ^2 \log (1-2 \lambda )-(\lambda -1)^2 \log ^3(1-2 \lambda )\Bigr] +\frac{b_2 \gamma A_1 \lambda ^2 (4 \lambda -3)}{2 \pi  b_0^2 (\lambda -1)^2 (2 \lambda -1)^2} & \nonumber\\
    &\frac{b_1 b_2 A_1}{12 \pi  b_0^4 (\lambda -1)^2 (2 \lambda -1)^2} \Bigl[\lambda ^2 (2 \lambda  (3-7 \lambda )+3)+3 \left(8 \lambda ^2-4 \lambda +1\right) (\lambda -1)^2 \log (1-2 \lambda )&\nonumber\\
    &-6 (1-2 \lambda )^2 (2 (\lambda -1) \lambda +1) \log (1-\lambda )\Bigr] + -\frac{b_3 A_1}{12 \pi  b_0^3 (\lambda -1)^2 (2 \lambda -1)^2} \Bigl[(2 (\lambda -3) \lambda +3) \lambda ^2&\nonumber\\
    &-6 \left(2 \lambda ^2-3 \lambda +1\right)^2 \log (1-\lambda )+3 \left(2 \lambda ^2-3 \lambda +1\right)^2 \log (1-2 \lambda )\Bigr] & \nonumber
\end{flalign}
...
\begin{flalign}\label{eq:f5}
    ...
    &-\frac{\gamma A_4 \lambda  \left(7 \lambda ^2-9 \lambda +3\right)}{3 \pi ^4 b_0 (\lambda -1)^3 (2 \lambda -1)^3} +\frac{b_1 A_4}{36 \pi ^4 b_0^3 (\lambda -1)^3 (2 \lambda -1)^3} \Bigl[7 \lambda ^2 (\lambda  (\lambda  (2 \lambda  (2 \lambda -9)+33)-24)&\nonumber\\
    &+6)-6 (\lambda -1)^3 \log (1-2 \lambda )+12 (2 \lambda -1)^3 \log (1-\lambda )\Bigr] + \frac{\gamma B_3 \lambda  \left(\lambda ^2-3 \lambda +3\right)}{2 \pi ^3 (\lambda -1)^3}+  & \nonumber\\
    &\frac{b_1 B_3\left(\lambda ^3-3 \lambda ^2+3 \lambda +3 \log (1-\lambda )\right)}{6 \pi ^3 b_0^2 (\lambda -1)^3} +\frac{\gamma ^2 A_3 \lambda  \left(8 \lambda ^5-36 \lambda ^4+66 \lambda ^3-69 \lambda ^2+39 \lambda -9\right)}{2 \pi ^3 (\lambda -1)^3 (2 \lambda -1)^3} & \nonumber\\
    &-\frac{b_1 \gamma A_3}{3 \pi ^3 b_0^2 (\lambda -1)^3 (2 \lambda -1)^3}  \Bigl[\lambda  ((9-7 \lambda ) \lambda -3)+3 (\lambda -1)^3 \log (1-2 \lambda )&\nonumber\\
    &-3 (2 \lambda -1)^3 \log (1-\lambda )\Bigr] +\frac{b_2 A_3\lambda ^3 \left(4 \lambda ^3-18 \lambda ^2+19 \lambda -6\right)}{4 \pi ^3 b_0^3 (\lambda -1)^3 (2 \lambda -1)^3}-& \nonumber\\
    &\frac{b_1^2 A_3}{36 \pi ^3 b_0^4 (\lambda -1)^3 (2 \lambda -1)^3} \Bigl[\lambda ^3(\lambda  (26 \lambda  (2 \lambda -9)+303)-150)-9 (\lambda -1)^3 \log ^2(1-2 \lambda )&\nonumber\\
    &+24 \lambda^2 -6 (\lambda -1)^3 \log (1-2 \lambda )+6 (2 \lambda -1)^3 \log (1-\lambda ) (3 \log (1-\lambda )+2)\Bigr] & \nonumber\\
    &+\frac{b_0 \gamma ^2 B_2 \lambda  \left(\lambda ^2-3 \lambda +3\right)}{2 \pi ^2 (\lambda -1)^3} -\frac{b_1 \gamma B_2 \log (1-\lambda )}{\pi ^2 b_0 (\lambda -1)^3} +\frac{b_1^2 B_2 \left(\lambda ^3-3 \lambda ^2+3 \log ^2(1-\lambda )\right)}{6 \pi ^2 b_0^3 (\lambda -1)^3}& \nonumber\\
    &-\frac{b_2 B_2 (\lambda -3) \lambda ^2}{6 \pi ^2 b_0^2 (\lambda -1)^3} + \frac{b_0 \gamma ^3 A_2 \lambda  \left(24 \lambda ^5-108 \lambda ^4+198 \lambda ^3-193 \lambda ^2+99 \lambda -21\right)}{3 \pi ^2 (\lambda -1)^3 (2 \lambda -1)^3} & \nonumber\\
    &+\frac{b_1^2 \gamma A_2}{3 \pi ^2 b_0^3 (\lambda -1)^3 (2 \lambda -1)^3} \Bigl[\lambda ^2 (\lambda  (18 \lambda -25)+9)+3 (\lambda -1)^3 \log ^2(1-2 \lambda )&\nonumber\\
    &-3 (2 \lambda -1)^3 \log ^2(1-\lambda )\Bigr] -\frac{b_2 \gamma A_2 \lambda ^2 \left(18 \lambda ^2-25 \lambda +9\right)}{3 \pi ^2 b_0^2 (\lambda -1)^3 (2 \lambda -1)^3} &\nonumber\\
    &+\frac{b_1^3 A_2}{36 \pi ^2 b_0^5 (\lambda -1)^3 (2 \lambda -1)^3} \Bigl[\lambda ^2 (\lambda  (\lambda  (2 \lambda  (50 \lambda -171)+339)-114)+6)&\nonumber\\
    &-6 (\lambda -1)^3 \log ^3(1-2 \lambda )+12 (2 \lambda -1)^3 \log (1-\lambda ) \left(-3 \lambda +\log ^2(1-\lambda )+1\right)&\nonumber\\
    &+6 (6 \lambda -1) (\lambda -1)^3 \log (1-2 \lambda )\Bigr]+\frac{b_3 A_2 \lambda ^3 \left(20 \lambda ^3-54 \lambda ^2+45 \lambda -12\right)}{12 \pi ^2 b_0^3 (\lambda -1)^3 (2 \lambda -1)^3} & \nonumber\\
    &-\frac{b_1 \gamma ^2 A_2}{\pi ^2 b_0 (\lambda -1)^3 (2 \lambda -1)^3} \Bigl[2 (\lambda -1)^3 \log (1-2 \lambda )-(2 \lambda -1)^3 \log (1-\lambda )\Bigr] & \nonumber\\
    &-\frac{b_2 b_1 A_2}{18 \pi ^2 b_0^4 (\lambda -1)^3 (2 \lambda -1)^3} \Bigl[\lambda ^2 (\lambda  (\lambda  (4 \lambda  (20 \lambda -63)+237)-75)+3)&\nonumber\\
    &+3 (6 \lambda -1) (\lambda -1)^3 \log (1-2 \lambda )-6 (2 \lambda -1)^3 (3 \lambda -1) \log (1-\lambda )\Bigr] & \nonumber \\
    &+\frac{b_0^2 \gamma ^3 B_1 \lambda  \left(\lambda ^2-3 \lambda +3\right)}{6 \pi  (\lambda -1)^3} -\frac{b_1^2 \gamma B_1  \left(\lambda -\log ^2(1-\lambda )+\log (1-\lambda )\right)}{2 \pi  b_0^2 (\lambda -1)^3}- & \nonumber\\
    &\frac{b_1^3 B_1}{12 \pi  b_0^4 (\lambda -1)^3}(\lambda +\log (1-\lambda )) \left(2 \lambda ^2-3 \lambda +2 \log ^2(1-\lambda )-2 \lambda  \log (1-\lambda )-3 \log (1-\lambda )\right) & \nonumber\\
    &+\frac{b_2 \gamma B_1 \lambda }{2 \pi  b_0 (\lambda -1)^3}-\frac{b_3 B_1 \lambda ^2 (2 \lambda -3)}{12 \pi  b_0^2 (\lambda -1)^3}+\frac{b_1 \gamma ^2 B_1 \left(\lambda ^3-3 \lambda ^2+3 \lambda -2 \log (1-\lambda )\right)}{4 \pi  (\lambda -1)^3} & \nonumber\\
    &+\frac{b_2 b_1 B_1 \lambda  \left(2 \lambda ^2-3 \lambda -3 \log (1-\lambda )\right)}{6 \pi  b_0^3 (\lambda -1)^3} +\frac{b_0^2 \gamma ^4 A_1}{12 \pi  (\lambda -1)^3 (2 \lambda -1)^3} \lambda  (2 \lambda -3) \Bigl[28 \lambda ^4 &\nonumber\\
    &-84 \lambda ^3+105 \lambda ^2-63 \lambda +15\Bigr] + \frac{b_1^3 \gamma A_1}{6 \pi  b_0^4 (\lambda -1)^3 (2 \lambda -1)^3} \Bigl[\lambda ^2 (4 \lambda  (3 (\lambda -3) \lambda +8)-9) &\nonumber\\
    &-2 (\lambda -1)^3 \log ^3(1-2 \lambda )+3 (\lambda -1)^3 \log ^2(1-2 \lambda )+12 \lambda  (\lambda -1)^3 \log (1-2 \lambda ) &\nonumber\\
    &+(2 \lambda -1)^3 \log (1-\lambda ) (\log (1-\lambda ) (2 \log (1-\lambda )-3) -6 \lambda )\Bigr] & \nonumber\\
    &+\frac{b_1^4 A_1}{24 \pi  b_0^6 (\lambda -1)^3 (2 \lambda -1)^3} \Bigl[8 (\lambda -1)^3 \lambda ^2 (4 \lambda -3) \log (1-2 \lambda )&\nonumber\\
    &-2 (2 \lambda -1)^3 \log (1-\lambda ) \left(2 (2 \lambda -3) \lambda ^2+\log (1-\lambda ) ((\log (1-\lambda )-2) \log (1-\lambda )-6 \lambda )\right)&\nonumber\\
    &+2 \lambda ^3 \left(\lambda  \left(-28 \lambda ^2+54 \lambda -33\right)+6\right)+(\lambda -1)^3 \log ^4(1-2 \lambda )-2 (\lambda -1)^3 \log ^3(1-2 \lambda )- &\nonumber\\
    &12 (\lambda -1)^3 \lambda  \log ^2(1-2 \lambda )\Bigr] -\frac{b_2 \gamma ^2 A_1 \lambda  \left(4 \lambda ^3-6 \lambda +3\right)}{2 \pi  b_0 (\lambda -1)^3 (2 \lambda -1)^3} +\frac{b_3 \gamma  \lambda ^2 \left(12 \lambda ^3-36 \lambda ^2+32 \lambda -9\right)}{6 \pi  b_0^2 (\lambda -1)^3 (2 \lambda -1)^3} & \nonumber\\
    &+\frac{b_2^2 A_1 }{36 \pi  b_0^4 (\lambda -1)^3 (2 \lambda -1)^3}\Bigl[\lambda ^2 (6-\lambda  (\lambda  (2 \lambda  (10 \lambda +9)-69)+42))&\nonumber\\
    &-12 \left(2 \lambda ^2-3 \lambda +1\right)^3 \log (1-\lambda )+6 \left(2 \lambda ^2-3 \lambda +1\right)^3 \log (1-2 \lambda )\Bigr] &\nonumber\\
    &+\frac{b_1^2 \gamma ^2 A_1}{2 \pi  b_0^2 (\lambda -1)^3 (2 \lambda -1)^3} \Bigl[\lambda  \left(4 \lambda ^3-6 \lambda +3\right)+2 (\lambda -1)^3 \log ^2(1-2 \lambda )&\nonumber\\
    &-2 (\lambda -1)^3 \log (1-2 \lambda )-(2 \lambda -1)^3 (\log (1-\lambda )-1) \log (1-\lambda )\Bigr] & \nonumber\\
    &-\frac{b_2 b_1^2 A_1}{36 \pi  b_0^5 (\lambda -1)^3 (2 \lambda -1)^3} \Bigl[\lambda ^2 (\lambda  (\lambda  (2 (153-82 \lambda ) \lambda -165)+12)+6)&\nonumber\\
    &-18 \lambda  (\lambda -1)^3 \log ^2(1-2 \lambda )+6 \left(6 (1-2 \lambda )^2 \lambda -1\right) (\lambda -1)^3 \log (1-2 \lambda )&\nonumber\\
    &-6 (2 \lambda -1)^3 \log (1-\lambda ) \left(6 \lambda  (\lambda -1)^2-3 \lambda  \log (1-\lambda )-2\right)\Bigr] & \nonumber \\
    &+\frac{b_1 \gamma ^3 A_1}{6 \pi  (\lambda -1)^3 (2 \lambda -1)^3} \Bigl[24 \lambda ^6-108 \lambda ^5+198 \lambda ^4-193 \lambda ^3 +16 \lambda ^3 \log (1-\lambda ) &\nonumber\\
    &-8 \lambda ^3 \log (1-2 \lambda )+99 \lambda ^2-24 \lambda ^2 \log (1-\lambda )+24 \lambda ^2 \log (1-2 \lambda )-21 \lambda &\nonumber\\
    &+12 \lambda  \log (1-\lambda )-24 \lambda  \log (1-2 \lambda )-2 \log (1-\lambda )+8 \log (1-2 \lambda )\Bigr] & \nonumber\\
    &-\frac{b_2 b_1 \gamma A_1}{3 \pi  b_0^3 (\lambda -1)^3 (2 \lambda -1)^3} \lambda  \Bigl[\lambda  (4 \lambda  (3 (\lambda -3) \lambda +8)-9)+6 (\lambda -1)^3 \log (1-2 \lambda )&\nonumber\\
    &-3 (2 \lambda -1)^3 \log (1-\lambda )\Bigr]+\frac{b_3 b_1 A_1}{18 \pi  b_0^4 (\lambda -1)^3 (2 \lambda -1)^3} \Bigl[\lambda ^3(\lambda  (4 (18-7 \lambda ) \lambda -51)+6) &\nonumber\\
    &+3 \lambda^2 +3 (2 \lambda  (\lambda  (8 \lambda -9)+3)-1) (\lambda -1)^3 \log (1-2 \lambda )&\nonumber\\
    &-3 (2 \lambda -1)^3 (\lambda  (\lambda  (4 \lambda -9)+6)-2) \log (1-\lambda )\Bigr] & \nonumber\\
